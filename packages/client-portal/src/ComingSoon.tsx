...
function ComingSoon() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      ...
      <div className={`relative z-10 text-center max-w-3xl mx-auto px-6 ${isVisible ? 'animate-fadeInUp' : 'opacity-0'}`}>
        <div className="mb-8">
          <img 
            src="/wizjock-logo.png" 
            alt="WizJock Logo" 
            className="w-32 h-32 mx-auto object-contain drop-shadow-2xl mb-6"
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
          <a 
            ...
            className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold px-8 py-4 rounded-xl transition-all transform hover:scale-105 shadow-lg"
          >
